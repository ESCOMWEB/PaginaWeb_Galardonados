...
session_start();
    ...
    $sql = "SELECT * FROM asistencia WHERE idGalardonado = '$idGalardonado'";
    $res = mysqli_query($conexion, $sql);
    $observaciones = mysqli_fetch_array($res);
...
//if($comprobando == '/'){
    ...
    $pdf->setXY(14,220);
    $pdf->Cell(40, 5, utf8_decode('ACOMPAÑANTE:'),0,0,'R',0);
    $pdf->Cell(40, 5, utf8_decode($observaciones[2]),0,0,'L',0);
    $pdf->Ln(5);
    $pdf->Cell(40, 5, utf8_decode('INCAPACIDAD:'),0,0,'R',0);
    $pdf->Cell(40, 5, utf8_decode($observaciones[3]),0,0,'L',0);
    $pdf->setXY(90,240);
