    ...
    <main class="page">
        ...
        <section class="container">
            ...
            <form role="form" method="POST" action="validarExito.php?id=<?php echo $id;?>">
                ...
                <button class="btn btn-primary pull-right" type="submit">Validar</button>
                <a href="principalDirector.php">
                    <button class="btn btn-default pull-right" type="button">Cancelar</button>
                </a>
            </form>
